#!/bin/sh
#PBS -N L20_D80_M6_Re3000_transient
#PBS -q mafat_new_q
...
# charles
charles_launch.sh -np 256 -mpi impi -mpi_dir /usr/local/intel21/mpi/2021.3.0 -target cpu --hostfile machines -perhost 256 charles_ig.exe -i transient_charles_ig.in > ./logs/charles_ig_out_$PBS_JOBID
