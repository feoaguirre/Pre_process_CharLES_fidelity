#!/bin/sh
#PBS -N L20_D80_M6_Re3000_3D_transient
#PBS -q mafat14_512_q
...
# charles
charles_launch.sh -np 512 -mpi impi -mpi_dir /usr/local/intel21/mpi/2021.3.0 -target cpu --hostfile machines -perhost 512 charles_ig.exe -i transient_charles_ig.in > ./logs/charles_ig_out_$PBS_JOBID
